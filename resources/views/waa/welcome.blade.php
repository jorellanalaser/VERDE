                        ...
                        <div id="main" class="tabs col-md-6 text-center">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="menu1" class="tab-pane fade">
                                    ...
                                    <form autocomplete="off" action="https://apps.kiusys.com/webcheckin/QL/check_data.php" method="POST" target="_blank">
                                        <!--   <form autocomplete="off" action="https://webcheckin.kiusys.com/web/QL_test/check_data.php" method="POST" target="_blank">
                                    <form autocomplete="off" action="https://apps.kiusys.com/webcheckin/QL/check_data.php" method="POST" target="_blank">-->
                                  <!--   <form autocomplete="off" action="https://webcheckin.kiusys.com/web/QL_test/check_data.php" method="POST" target="_blank"> -->
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input placeholder="@lang('home.checkin.PNR')" class="form-control" type="text" id="code" name="code" autocomplete="off" maxlength="6" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input placeholder="@lang('register.last_name')" class="form-control" type="text" name="last_name" id="last_name" autocomplete="off" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-md-offset-6">
                                            <div class="form-group">
                                                <button class="btn btn-send" style="width:100%;">Check-in</button>
                                            </div>
                                        </div>
                                        <br><br><br><br>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>@lang('home.checkcancel.content')</p><a class="btn btn-send" style="margin-left: 5%; margin-bottom: 2.3%;" href="https://apps.kiusys.com/webcheckin/QL/del_index.php" target="_blank">
                                                    @lang('home.checkcancel.title')
                                                </a>
                                            </div>
                            ...
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="item fondobannercaru">
                                    <div class="col-xs-10 col-xs-offset-1" style="margin-top: 5.6%;">
                                        <img alt="LaserAirlines" class="img-responsive" src="{{ asset('img/miaeq1.png') }}">
                                        </img>
                                    </div>
                                </div>
                                -->
                                    ...
                                    <div class="item fondobannercaru">
                                        <div class="col-xs-10 col-xs-offset-1" style="margin-top: 5.6%;">
                                            <img alt="LaserAirlines" class="img-responsive" src="{{ asset('img/inteq1.png') }}">
                                            </img>
                                        </div>
                                    </div>
                                    <div class="item fondobannercaru">
                                        <div class="col-xs-10 col-xs-offset-1" style="margin-top: 5.6%;">
                                            <img alt="LaserAirlines" class="img-responsive" src="{{ asset('img/naceq1.png') }}">
                                            </img>
                                        </div>
                                    </div>
                                    <div class="item fondobannercaru">
                                        <div class="col-xs-10 col-xs-offset-1" style="margin-top: 5.6%;">
                                            <img src="{{ asset('img/DestInt_1.png') }}" class="img-responsive" alt="LaserAirlines">
                                        </div>
                                    </div>
                                    <div class="item fondobannercaru">
                                    ...
                                    <div class="item fondobannercaru">
                                        <div class="col-xs-10 col-xs-offset-1" style="margin-top: 4%; margin-bottom: 1.9%;">
                                            <img src="{{ asset('img/pii4.png') }}" class="img-responsive" alt="LaserAirlines">
                                        </div>
                                    </div>
                                    <div class="item fondobannercaru">
                                        <div class="col-xs-10 col-xs-offset-1" style="margin-top: 4%; margin-bottom: 1.9%;">
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content" >
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <a href="{{ url('content/news') }}">
                            <img src="{{ asset('img/compras_ter3_1.png') }}"  alt="LaserAirlines">
                        </a>
                    </div>
                </div>
            </div>
