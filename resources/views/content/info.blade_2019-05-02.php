                    ...
                    <div class="panel-body">
                        <p align="justify" style="margin-left:7%;">
                            <ul>
                                ...
                                <br>
                                <p align="justify"><b>@lang('static.info.frequentlyq.mascotsLA.p19')</b></p>
                                <li align="justify">@lang('static.info.frequentlyq.mascotsLA.p20')</li>
                    ...
                    <div class="panel-body">
                        <p align="justify" style="margin-left:7%;">
                            <ul>
                                ...
                                <br>
								<!-- Emocional -->
                                <p><b align="justify">@lang('static.info.frequentlyq.mascotsSA.p35')</b></p>
                                <li align="justify">@lang('static.info.frequentlyq.mascotsSA.p36')</li>
